        ...
        <div class="row">
            <div class="col-12 col-md-4 offset-md-4" style="margin-top: 150px;">
                ...
                <div class="d-none" id="msg">
                    ...
                    <div class="mb-4">
                        <button class="btn-signIn col-12 font-weight-bold" type="submit" onclick="signIn();">Sign In</button>
                        <p class="fw-bold text-center mt-3">Don't have an account.<a href="signUp.php">Click here.</a></p>
                        <p class="fw-bold text-center">Admin sign in..<a href="adminSignIn.php">Click here.</a></p>
                    </div>
            </div>
